...
export const PostCard: React.FC<PostFrontmatter> = ({
    ...
    return (
        <div
            key={id}
            className="mb-12 w-full max-w-152 rounded-lg bg-white text-[rgb(var(--color-text-primary))] shadow-card transition-all duration-300 hover:scale-[1.02] hover:shadow-card-hover max-sm:max-w-full"
        >
