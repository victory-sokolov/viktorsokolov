...
kport()
{
    ...
    local header="PID    CPU%   MEM%   COMMAND PORT"
...
<img src="/tips/interactively-kill-processes-with-fzf/kport-with-fzf.gif" alt="Kill processes interactively with FZF" width={800} height={450} />
