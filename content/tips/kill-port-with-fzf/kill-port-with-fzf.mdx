...
description: Interactively search and kill processes using FZF with customizable signals
slug: interactively-kill-processes-with-fzf
date: 2026-01-17
featureImage: interactively-kill-processes-with-fzf.png
tags: bash, fzf
---
...
kport() # Kill processes interactively with fzf (supports port number search)
{
    ...
    signal="15"  # Always use SIGTERM (15)
...
<img src="/tips/kill-port-with-fzf/kport-with-fzf.gif" alt="FZF npm script runner in action" width={800} height={450} />
